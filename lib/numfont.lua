function PlaceNum(g,x,y,n)
	...
	local function Two(g,x,y)
		g.fill(x,y,14,2,1)
		g.fill(x,y+2,6,2,1)
		g.fill(x+2,y+4,8,2,1)
		g.fill(x+4,y+6,8,2,1)
		g.fill(x+8,y+8,6,2,1)
		g.fill(x+10,y+10,4,2,1)
	...
	local function Four(g,x,y)
		g.fill(x+8,y,4,14,1)
		g.fill(x+0,y+4,14,2,1)
		g.fill(x+0,y+6,4,2,1)
		g.fill(x+2,y+8,4,2,1)
		g.fill(x+4,y+10,4,2,1)
		g.fill(x+6,y+12,2,2,1)
	end
	local function Five(g,x,y)
		g.fill(x+2,y,10,2,1)
		g.fill(x+0,y+2,4,2,1)
		g.fill(x+10,y+2,4,6,1)
		g.fill(x+0,y+8,12,2,1)
		g.fill(x+0,y+10,4,4,1)
		g.fill(x+4,y+12,8,2,1)
	end
	local function Six(g,x,y)
		g.fill(x+2,y,10,2,1)
		g.fill(x+0,y+2,4,8,1)
		g.fill(x+10,y+2,4,4,1)
		g.fill(x+4,y+6,8,2,1)
